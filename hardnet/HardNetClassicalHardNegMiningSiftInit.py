...
from pytorch_sift import SIFTNet # Affnet siftnet
import faiss # Fair AI similarity search package
...
# get the closet non-matching negative patches from batch_size data
...
def main(trainPhotoTourDataset, test_loaders, model, logger, file_logger):
    ...
    for epoch in range(start, end):
        ...
        if(not first_init):
            ...
            # here using the sift net to init the HardNet
