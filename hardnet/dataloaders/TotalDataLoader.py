...
class TotalDatasetsLoader(data.Dataset):
    ...
    def __init__(self, datasets_path, train = True, transform = None, batch_size = None, n_triplets = 100000, fliprot = False, *arg, **kw):
        ...
        del datasets # garbage recollection
        ...
        # call the function using TotalDatasetsLoader.generate_triplets(...)
        @staticmethod
        def generate_triplets(labels, num_triplets):
            """
            get the triplet indices for a bunch data of batch_size
            build the random non-match indices first
            """
        ...
        # return the element value using index
        def __getitem__(self, index):
            ...
            # transform images if required, data augmentation
            if fliprot:
